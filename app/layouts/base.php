<?php
// Necesario para verificar si el usuario esta logueado
...
<head>
	...
	<title><?php echo $title ?? "CriptoJourney"; ?> </title>
	<?php if ($extra_styles === true): ?>
		<link rel="stylesheet" href="web/css/<?php echo $extra_styles_filename; ?>.css">
	<?php endif; ?>
</head>
			...
			<nav class="menu-desplegable">
				...
				<div id="menu" class="menu-header">
					...
					<?php if (isset($_SESSION['user_id'])): ?>
						<a href="/app/views/admin/dashboard.php" class="header-link">Admin</a>
						<a href="/logout.php" class="header-link">Salir</a>
					<?php else: ?>
						<a href="criptoJourney/login.php" class="header-link">Login</a>
					<?php endif; ?>
				</div>
			</nav>
		</div>
	...
	<footer class="site-footer">
		<div class="footer-container">
			...
			<div class="footer-column contacto">
				<h4>Contacto</h4>
				<ul>
					<li><a href=""><svg class="icon" data-testid="geist-icon" height="16" stroke-linejoin="round"
					...
					<li><a href="https://github.com/sfloresdev/criptojourney"><svg class="icon" data-testid="geist-icon"
			...
			<div class="footer-stats">
				<p class="stats-icon"><svg data-testid="geist-icon" height="16" stroke-linejoin="round"
						viewBox="0 0 16 16" width="16">
						<path fill-rule="evenodd" clip-rule="evenodd"
				...
				<p class="stats-count"><span id="visitor-count">0</span> visitantes</p>
